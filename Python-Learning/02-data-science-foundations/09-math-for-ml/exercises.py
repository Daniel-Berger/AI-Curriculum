"""
Module 09: Math for ML - Exercises
==================================

15 exercises implementing mathematical concepts in NumPy:
- Linear algebra (vectors, matrices, operations)
- Calculus (derivatives, gradients)
- Probability (Bayes theorem)
- Statistics (hypothesis testing, distributions)

All exercises use NumPy for computation.
...
if __name__ == "__main__":
    print("Running Math for ML tests...\n")
